def add_node_config(node_name, config):
    """
    Adds a new node configuration to NODE_CONFIGS.

    :param node_name: Name of the node to add or update.
    :param config: Dictionary containing the configuration for the node.
    """
...
"""
    ...
    "TemporalMaskBase":{
            "ADDITIONAL_INFO":"""- `Start Frame`: The frame number where the effect begins (0 to 1000).
...
"""
     ...
     "OpticalFlowMaskBase":{
         "ADDITIONAL_INFO":"""- `Images`: Input image sequence for optical flow calculation
...
""",
         "ADDITIONAL_INFO":"""- `Modulation Strength`: Intensity of the modulation effect (0.0 to 5.0). Higher values create more pronounced motion trails.
...
- `Max Thickness`: Maximum trail thickness for thickness-based decay (1 to 50 pixels). Larger values create thicker trails."""
    ...
    "MaskTransform":{
        "ADDITIONAL_INFO":"""- `Transform Type`: The type of transformation to apply.
...
""",
    ...
    "MaskMorph": {
        ...
        "ADDITIONAL_INFO": """- `Morph Type`: The type of morphological operation to apply.
...
- `Max Iterations`: Maximum number of times to apply the operation (1 to 50). More iterations create more extreme effects."""
   ...
   "ADDITIONAL_INFO":""""- `Mask B`: Second mask to combine with the input mask.
- `Combination Method`: Mathematical operation to apply.
  - Options: "add", "subtract", "multiply", "minimum", "maximum" """
   ...
   "ADDITIONAL_INFO":"""- `Num Rings`: Number of rings to generate (1 to 50). More rings create more detailed patterns.
- `Max Ring Width`: Maximum width of each ring as a fraction of the total distance (0.01 to 0.5). Larger values create wider rings."""
    ...
    "MaskWarp":{
            "ADDITIONAL_INFO":"""- `Warp Type`: The type of warping effect to apply. Each creates a different distortion pattern.
